...
insert into dhcp4_options(code, formatted_value, space, persistent, host_id, scope_id, client_classes) values(14, '/tmp/dump/dhcp', 'dhcp4', 0, @selected_host, 3, '[]');
insert into dhcp4_options(code, formatted_value, space, persistent, host_id, scope_id, client_classes) values(3, '10.2.12.1', 'dhcp4', 1, @selected_host, 3, '[]');
insert into dhcp4_options(code, formatted_value, space, persistent, host_id, scope_id, client_classes) values(20, 'true', 'dhcp4', 0, @selected_host, 3, '[]');

select host_id from hosts where ipv4_address = inet_aton('192.110.111.242') into @selected_host;
insert into dhcp4_options(code, formatted_value, space, persistent, host_id, scope_id, client_classes) values(20, 'false', 'dhcp4', 0, @selected_host, 3, '[]');

select host_id from hosts where hex(dhcp_identifier) = 'abc76efabdeaae' into @selected_host;
insert into dhcp6_options(code, formatted_value, space, persistent, host_id, scope_id, client_classes) values(23, '2001:db8:1::1,2001:db8:1::1', 'dhcp6', 1, @selected_host, 3, '[]');
insert into dhcp6_options(code, formatted_value, space, persistent, host_id, scope_id, client_classes) values(51, 'foo.example.org.', 'dhcp6', 1, @selected_host, 3, '[]');
...
insert into dhcp6_options(code, formatted_value, space, persistent, host_id, scope_id, client_classes) values(94, '', 'dhcp6', false, @selected_host, 3, '[]');
insert into dhcp6_options(code, formatted_value, space, persistent, host_id, scope_id, client_classes) values(89, '12,13,14,192.0.2.1,3001::/64', 's46-cont-mape-options', false, @selected_host, 3, '[]');
insert into dhcp6_options(code, formatted_value, space, persistent, host_id, scope_id, client_classes) values(93, '18,21/13', 's46-rule-options', false, @selected_host, 3, '[]');
