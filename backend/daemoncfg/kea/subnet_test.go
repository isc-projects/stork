...
func TestDecodeAllKeysSubnet4(t *testing.T) {
	...
	require.NotNil(t, params.GetPools()[0].UnknownParameters)
	require.Len(t, params.GetPools()[0].UnknownParameters, 2)
	require.Equal(t, "x", params.GetPools()[0].UnknownParameters["hostname-char-replacement"])
	require.Equal(t, "[^A-Za-z0-9.-]", params.GetPools()[0].UnknownParameters["hostname-char-set"])
	...
	require.NotNil(t, params.GetPools()[1].UnknownParameters)
	require.Len(t, params.GetPools()[1].UnknownParameters, 2)
	require.Equal(t, "x", params.GetPools()[1].UnknownParameters["hostname-char-replacement"])
	require.Equal(t, "[^A-Za-z0-9.-]", params.GetPools()[1].UnknownParameters["hostname-char-set"])
