...
func (at *AllowTransfer) IsDisabled() bool {
	...
	return at.AddressMatchList == nil || len(at.AddressMatchList.Elements) == 0 || !slices.ContainsFunc(at.AddressMatchList.Elements, func(ame *AddressMatchListElement) bool {
