...
func testParsedConfig(t *testing.T, cfg *Config) {
	...
	require.Equal(t, "domain.name", statement.Option.Switches[0].GetValue())
	...
	require.Equal(t, "no", statement.View.Clauses[7].Option.Switches[0].GetValue())
	...
	require.Equal(t, "master", statement.Zone.Clauses[0].Option.Switches[0].GetValue())
	...
	require.Equal(t, "/etc/bind/db.nsd.example.com", statement.Zone.Clauses[2].Option.Switches[0].GetValue())
...
func TestParseGenericOption(t *testing.T) {
	...
	require.Equal(t, "192.168.1.1", cfg.Statements[0].Options.Clauses[0].Option.Switches[0].GetValue())
	require.Equal(t, "2001:db8:1::1", cfg.Statements[0].Options.Clauses[0].Option.Switches[1].GetValue())
	require.Equal(t, "12", cfg.Statements[0].Options.Clauses[0].Option.Switches[2].GetValue())
	require.Equal(t, "bar", cfg.Statements[0].Options.Clauses[0].Option.Switches[3].GetValue())
	require.Equal(t, "1.1.1.1", cfg.Statements[0].Options.Clauses[0].Option.Switches[4].GetValue())
	...
	require.Equal(t, "192.0.2.1", cfg.Statements[0].Options.Clauses[0].Option.Suboptions[0].Switches[0].GetValue())
	...
	require.Equal(t, "smiley", cfg.Statements[0].Options.Clauses[0].Option.Suboptions[1].Switches[0].GetValue())
	require.Equal(t, "123", cfg.Statements[0].Options.Clauses[0].Option.Suboptions[1].Switches[1].GetValue())
...
func TestParseOptionWithCurlyBrackets(t *testing.T) {
	...
	require.Equal(t, "123", cfg.Statements[0].Options.Clauses[0].Option.Switches[0].GetValue())
	require.Equal(t, "abc", cfg.Statements[0].Options.Clauses[0].Option.Switches[1].GetValue())
	require.NotNil(t, cfg.Statements[0].Options.Clauses[0].Option.Contents)
	require.Empty(t, cfg.Statements[0].Options.Clauses[0].Option.Suboptions)
}
...
func TestParseOptionWithSuboptions(t *testing.T) {
	...
	require.Equal(t, "100", cfg.Statements[0].Options.Clauses[0].Option.Suboptions[1].Switches[0].GetValue())
}
...
func TestParseDynDB(t *testing.T) {
	...
	require.Equal(t, "ipa", cfg.Statements[0].Option.Switches[0].GetValue())
	require.Equal(t, "/usr/lib64/bind/ldap.so", cfg.Statements[0].Option.Switches[1].GetValue())
