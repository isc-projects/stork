...
func TestXfrTrackerFeed(t *testing.T) {
	...
	require.NotNil(t, completed[0].Serial)
	require.EqualValues(t, 201702121, *completed[0].Serial)
	...
	require.NotNil(t, completed[1].Serial)
	require.EqualValues(t, 2026041600, *completed[1].Serial)
	...
	require.NotNil(t, completed[2].Serial)
	require.EqualValues(t, 201702121, *completed[2].Serial)
	...
	require.NotNil(t, completed[3].Serial)
	require.EqualValues(t, 2026041600, *completed[3].Serial)
