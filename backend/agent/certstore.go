...
var (
	KeyPEMFile                = "/var/lib/stork-agent/certs/key.pem"
	CertPEMFile               = "/var/lib/stork-agent/certs/cert.pem"
	RootCAFile                = "/var/lib/stork-agent/certs/ca.pem"
	AgentTokenFile            = "/var/lib/stork-agent/tokens/agent-token.txt" //#nosec: G101
	ServerCertFingerprintFile = "/var/lib/stork-agent/tokens/server-cert.sha256"
)
