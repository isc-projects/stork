...
func TestTextFileLogReaderFollowFromStart(t *testing.T) {
	...
	// first log line.
	lines, err := reader.capture(ctx, logReaderCaptureOptionReadFollow)
	require.NoError(t, err)
...
func TestTextFileLogReaderFollowFromEnd(t *testing.T) {
	...
	// first log line.
	lines, err := reader.capture(ctx, logReaderCaptureOptionReadFromEnd, logReaderCaptureOptionReadFollow)
	require.NoError(t, err)
	require.NotNil(t, lines)
...
func TestTextFileLogReaderReadFromEnd(t *testing.T) {
	...
	lines, err := reader.capture(ctx, logReaderCaptureOptionReadFromEnd)
