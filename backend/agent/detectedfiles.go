...
// Creates a new detected daemon file instance.
func newDetectedDaemonFile(fileType detectedFileType, path string) *detectedDaemonFile {
...
func (df *detectedDaemonFiles) addFile(fileType detectedFileType, path string) {
	detectedFile := newDetectedDaemonFile(fileType, path)
