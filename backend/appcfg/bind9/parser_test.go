...
func TestParseFile(t *testing.T) {
	...
	require.Len(t, statement.Options.Clauses, 8)
	...
	require.Len(t, statement.View.Clauses, 5)
	...
	require.NotNil(t, statement.View.Clauses[3].Zone)
	require.Equal(t, "bind9.example.com", statement.View.Clauses[3].Zone.Name)
	require.NotNil(t, statement.View.Clauses[4].Zone)
	require.Equal(t, "pdns.example.com", statement.View.Clauses[4].Zone.Name)
