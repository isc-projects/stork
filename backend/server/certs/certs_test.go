...
// Copied-and-pasted unit tests for copied-and-pasted domainNameValid function.
// Source: function "TestDomainNameValid" in the
// tools/golang/go/src/crypto/x509/parser_test.go file.
