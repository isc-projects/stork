...
type Settings struct {
	...
	IdentityProviderID   string                `long:"oidc-provider-id" description:"Optional. The OID Provider identifier. Update it whenever you change the OID Provider in your Stork deployment so that each Provider has unique identifier." env:"STORK_OIDC_PROVIDER_ID" default:"oidc"`
}
