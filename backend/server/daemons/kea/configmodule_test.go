...
func TestApplySubnetAddToConfigBackend(t *testing.T) {
	...
	daemon1 := newTestDaemonWithConfig(t, daemonname.DHCPv4, storkutil.Ptr("server"), hookCbCmds)
	daemon2 := newTestDaemonWithConfig(t, daemonname.DHCPv4, storkutil.Ptr("server"), hookCbCmds)
