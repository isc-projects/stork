...
func RegisterDefaultCheckers(dispatcher Dispatcher) {
	...
	dispatcher.RegisterChecker(KeaDHCPDaemon, "gathering_statistics_unavailable_due_to_number_overflow", GetDefaultTriggers(), gatheringStatisticsUnavailableDueToNumberOverflow)
