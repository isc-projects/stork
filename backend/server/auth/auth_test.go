...
const noneGroupID dbconst.UserGroupID = 0

// Helper function checking if the user belonging to the specified group
// has access to the resource.
func authorizeAccept(t *testing.T, groupID dbconst.UserGroupID, path, method string) bool {
...
func TestAuthorize(t *testing.T) {
	...
	require.False(t, authorizeAccept(t, dbconst.AdminGroupID, "/users?start=0&limit=10", "GET"))
	require.False(t, authorizeAccept(t, dbconst.AdminGroupID, "/users/list", "GET"))
	require.False(t, authorizeAccept(t, dbconst.AdminGroupID, "/users/4/password", "GET"))
	require.False(t, authorizeAccept(t, dbconst.AdminGroupID, "/users//4/password/", "GET"))
	require.True(t, authorizeAccept(t, dbconst.AdminGroupID, "/users/5", "GET"))
	require.True(t, authorizeAccept(t, dbconst.AdminGroupID, "/users/5/password", "GET"))
	require.True(t, authorizeAccept(t, dbconst.AdminGroupID, "/users//5//password", "GET"))

	// Super-admin has no such restrictions.
	require.True(t, authorizeAccept(t, dbconst.SuperAdminGroupID, "/users?start=0&limit=10", "GET"))
	require.True(t, authorizeAccept(t, dbconst.SuperAdminGroupID, "/users/list", "GET"))
	require.True(t, authorizeAccept(t, dbconst.SuperAdminGroupID, "/users/4/password", "GET"))
	require.True(t, authorizeAccept(t, dbconst.SuperAdminGroupID, "/users//4/password/", "GET"))
	require.True(t, authorizeAccept(t, dbconst.SuperAdminGroupID, "/users/5", "GET"))
	require.True(t, authorizeAccept(t, dbconst.SuperAdminGroupID, "/users/5/password", "GET"))
	require.True(t, authorizeAccept(t, dbconst.SuperAdminGroupID, "/users//5//password", "GET"))

	// Admin group have no restriction on machines.
	require.True(t, authorizeAccept(t, dbconst.AdminGroupID, "/machines/1/", "GET"))
	...
	require.False(t, authorizeAccept(t, dbconst.UserGroupID(999), "/machines/1/", "GET"))
