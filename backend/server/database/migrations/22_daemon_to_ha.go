...
func init() {
	migrations.MustRegisterTx(func(db migrations.DB) error {
		_, err := db.Exec(`
            DELETE FROM service;
            -- Existing foreign keys point to the app table, therefore they
            -- have to be dropped.
            ...
            -- The app_to_service provides M:N relation between services and apps.
            -- We want to modify this relation to be between apps and daemons.
            ...
            -- Add the constraint back against the daemon table this time.
