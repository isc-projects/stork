...
import { MessageService, TableState, PrimeTemplate, MenuItem, FilterMetadata } from '@openng/optimus-ui/api'
...
export class SharedNetworksTableComponent implements OnInit, OnDestroy {
     ...
     * @param filterConstraint OptimusUI table filter metadata to be set
