...
describe('StorkValidators', () => {
    ...
    it('detects overlaps in the IPv4 address ranges', () => {
        let fa = new FormArray([
            new FormGroup<AddressPoolForm>({
                ...
                selectedDaemonGroups: new FormControl([]),
            }),
            new FormGroup<AddressPoolForm>({
                range: new FormGroup<AddressRangeForm>({
    ...
    it('validates that a prefix is not in the list', () => {
        ...
        // Deny by https://github.com/ip-num/ip-num/releases/tag/v1.6.2 to prevent CVE-2021-29921.
        expect(StorkValidators.prefixInList(subnets)(formBuilder.control('192.0.02.0/24'))).toBeFalsy()
    })
