...
const Template: Story<SharedNetworkTabComponent> = (args: SharedNetworkTabComponent) => ({
    props: args,
})

export const SharedNetwork4 = Template.bind({})
SharedNetwork4.args = {
    sharedNetwork: {
        name: 'foo',
        addrUtilization: 30,
        pools: [
            ...
            '192.0.2.150-192.0.2.160',
            '192.0.3.1-192.0.3.10',
            '192.0.3.100-192.0.3.110',
            '192.0.3.150-192.0.3.160',
        ],
        subnets: [
            {
                id: 1,
...
export const SharedNetwork6 = Template.bind({})
SharedNetwork6.args = {
    sharedNetwork: {
        name: 'foo',
        ...
        addrUtilization: 30,
        pdUtilization: 60,
        pools: ['2001:db8:1::2-2001:db8:1::786', '2001:db8:2::2-2001:db8:2::786'],
        subnets: [
            {
                id: 1,
