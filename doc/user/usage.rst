...
- The ``password`` must consist of an uppercase and lowercase letter A-Z, digit 0-9,
  and any ASCII special characters or whitespace characters; it must be at least twelve characters long.
